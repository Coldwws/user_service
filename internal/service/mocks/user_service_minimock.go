...
//go:generate minimock -i user_service/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcUpdate          func(ctx context.Context, id int64, user *model.User) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, id int64, user *model.User)
...
// UserServiceMockListOrigins contains origins of expectations of the UserService.List
...
// List implements mm_service.UserService
	...
	if mmList.ListMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.limit != nil && !minimock.Equal(*mm_want_ptrs.limit, mm_got.limit) {
				mmList.t.Errorf("UserServiceMock.List got unexpected parameter limit, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.offset != nil && !minimock.Equal(*mm_want_ptrs.offset, mm_got.offset) {
				mmList.t.Errorf("UserServiceMock.List got unexpected parameter offset, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, user *model.User) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) ExpectUserParam3(user *model.User) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, user *model.User)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, user *model.User) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, user *model.User) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, user *model.User) (err error) {
