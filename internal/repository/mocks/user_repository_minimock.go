...
//go:generate minimock -i user_service/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
	...
	if mmList.ListMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.limit != nil && !minimock.Equal(*mm_want_ptrs.limit, mm_got.limit) {
				mmList.t.Errorf("UserRepositoryMock.List got unexpected parameter limit, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.offset != nil && !minimock.Equal(*mm_want_ptrs.offset, mm_got.offset) {
				mmList.t.Errorf("UserRepositoryMock.List got unexpected parameter offset, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id int64, user *model.User) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectUserParam3(user *model.User) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, user *model.User)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, user *model.User) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id int64, user *model.User) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id int64, user *model.User) (err error) {
